    ...
    methods: {
        ...
        getNearestCity(e, t) {
            ...
            return fetch(n)
                .then(s => s.json())
                .then(s => {
                    const addressComponent = s.results[0].address_components.find(o =>
                        o.types.includes("locality") || o.types.includes("administrative_area_level_3")
                    );

                    return addressComponent ? addressComponent.long_name : "\u041D\u0435 \u0437\u043D\u0430\u0439\u0434\u0435\u043D\u043E \u043C\u0456\u0441\u0442\u043E";
                })
                .catch(() => {
